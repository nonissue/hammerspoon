...
function obj:init()
    ...
    obj.canvas:level(hs.canvas.windowLevels.overlay)
    obj.canvas[1] = {
        id = "watch_image",
        type = "image",
    ...
    obj.canvas[3] = {
        ...
        type = "arc",
        radius = "40%",
        fillColor = {hex="#eee", alpha=00},
        strokeColor = {hex="#9E9E9E", alpha=0.9},
        endAngle = 0,
    }
    obj.canvas[4] = {
        id = "watch_hourcircle",
    ...
    obj.canvas[5] = {
        ...
        -- action = "stroke",
        radius = "40%",
        fillColor = {hex="#EC6D27", alpha=0.5},
        -- arcRadii = false,
        strokeWidth = 1,
        strokeColor = {hex="#EC6D27", alpha=1},
        endAngle = 0,
    }
    obj.canvas[6] = {
        id = "watch_mincircle",
    ...
    obj.canvas[7] = {
        id = "watch_minarc",
        type = "arc",
        fillColor = {hex="#1891C3", alpha=0.5},
        -- action = "stroke",
        radius = "27%",
        -- arcRadii = false,
        strokeWidth = 1,
