...
-- The following seems to have become my faovourite but it's naming is ridiculous as it has a bg
-- wtf.
...
alerts_nobg_sml = {fillColor = { white = 0, alpha = 1 }, radius = 20, strokeColor = { white = 1, alpha = 0.1}, strokeWidth = 10, textSize = 28, textColor = { white = 1, alpha = 1}}
