...
obj.alert.colors = {
    ...
    darkmode = {
        fillColor = {hex = "#0B0B11", alpha = 0.95},
        strokeColor = {hex = "#084887", alpha = 0.3},
        ...
        textStyle = {
            shadow = {
                offset = {w = 2, h = -2},
                blurRadius = 5,
                -- color = {hex = "#F8FBE6", alpha = 0.2}
                color = {hex = "#333", alpha = 0.5}
            },
            kerning = -1
        }
    },
...
obj.alert_success = obj.createStyle(obj.alert.sizes[2], obj.alert.colors.success)
...
local warningStyle = {
    textFont = ".AppleSystemUIFontBold",
    strokeWidth = 10,
    strokeColor = {hex = "#FF3D00", alpha = 0.9},
    radius = 1,
