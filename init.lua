        ...
        if string.sub(file, -4) == ".png" then
            ...
            if string.sub(fileName, 1, 3) == "apw" and wasCreated then
                if hs.pasteboard.readDataForUTI("public.file-url") == filePath then
                    ...
                    hs.notify.new({title = "Screenshot!", subtitle = "New screenshot detected", informativeText = "Screenshot copied to clipboard", alwaysPresent = true, autoWithdraw = true}):send()
                    wasCreated = false
