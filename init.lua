...
hs.loadSpoon("Coach"):start({showMenu = true, animate = true})
------------------------------------------------------------------------------
--                                END OF SPOONS                             --
------------------------------------------------------------------------------
...
-- physicalTouchbar = require("physical-touchbar")
-- sliderTouchbar = require("touchbar-slider")
-- virtTouchbar = require("virt-touchbar")
